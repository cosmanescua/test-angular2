System.register(['./clients.service', '@angular/core', './client.model'], function(exports_1, context_1) {
    "use strict";
    ...
    var clients_service_1, core_1, client_model_1;
    var ClientsCmp;
    return {
        setters:[
            ...
            function (client_model_1_1) {
                client_model_1 = client_model_1_1;
            }],
        execute: function() {
            ClientsCmp = (function () {
            ...
            exports_1("ClientsCmp", ClientsCmp);
        }
    }
});
