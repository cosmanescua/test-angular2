...
const routes: Routes = [
  ...
  { path:'clientsTest',loadChildren:'app/clients/clients.module#ClientsModule', canActivate:[RouteAccessGuard]},
  { path:'filesTest',loadChildren:'app/test_file_upload/filesTest.module#FilesTestModule', canActivate:[RouteAccessGuard]},
