...
var ClientsDataAccess = (function () {
    function ClientsDataAccess(router, _cookieService) {
        this.router = router;
        this._cookieService = _cookieService;
        this._allowedUsers = ['daniel'];
    }
    //only users in _allowedUsers can access the requested route
    ClientsDataAccess.prototype.canActivate = function () {
    ...
    ClientsDataAccess.prototype.verifyUserPermissions = function () {
    ...
    ClientsDataAccess.prototype.getCurrentUser = function () {
        if (this._cookieService.get("user"))
            return JSON.parse(this._cookieService.get("user")).username;
        return null;
    };
    ClientsDataAccess = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [router_1.Router, core_2.CookieService])
    ], ClientsDataAccess);
    return ClientsDataAccess;
}());
exports.ClientsDataAccess = ClientsDataAccess;
//# sourceMappingURL=clientsDataAccess.service.js.map